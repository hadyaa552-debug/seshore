export default function MobileBottomBar() {
  ...
  const whatsappMessage = encodeURIComponent("مرحباً، أنا مهتم بمشروع Seashore Hyde Park الساحل الشمالي. أود الحصول على المزيد من المعلومات.")
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-background border-t border-border shadow-lg">
      <div className="grid grid-cols-2 gap-0">
        <a href={`tel:${phoneNumber}`}
          className="flex items-center justify-center gap-2 py-4 bg-primary text-white font-semibold text-sm hover:bg-primary/90 transition-colors">
